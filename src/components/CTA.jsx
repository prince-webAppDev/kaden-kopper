  ...
  return (
    ...
    >
      <div className="relative z-10 w-full flex flex-col items-center">
        {/* Translucent white band */}
        <div className="bg-white/85 w-full py-10 md:py-14 px-4 text-center shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row w-full max-w-5xl mx-auto">
          <a 
            href="#" 
            className="flex-1 bg-[#128C7E] hover:bg-[#075E54] text-white flex items-center justify-center gap-2 py-4 px-4 font-sans font-bold text-sm sm:text-base transition-colors"
          >
          ...
          <a 
            href="#" 
            className="flex-1 bg-[#D9118A] hover:bg-[#b00d70] text-white flex items-center justify-center gap-2 py-4 px-4 font-sans font-bold text-sm sm:text-base transition-colors"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
